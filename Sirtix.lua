...
local Window    = UILib.new("Sirtix", "Sirtix User", "Premium")
local Category1 = Window:Category("Local", "http://www.roblox.com/asset/?id=8395621517")
local Category2 = Window:Category("Visuals", "http://www.roblox.com/asset/?id=8395621517")
local Category3 = Window:Category("Players", "http://www.roblox.com/asset/?id=8395621517")

local Category4 = Window:Category("Client", "http://www.roblox.com/asset/?id=8395621517")

local Category5 = Window:Category("R.A.T", "http://www.roblox.com/asset/?id=8395621517")

local SubButtonBasic = Category5:Button("Basic", "http://www.roblox.com/asset/?id=8395747586")

local SubButton1   = Category1:Button("Movement", "http://www.roblox.com/asset/?id=8395747586")
local SubButton2   = Category1:Button("Health", "http://www.roblox.com/asset/?id=8395747586")
local SubButton3   = Category1:Button("Abilities", "http://www.roblox.com/asset/?id=8395747586")
local SubButtonCOS = Category1:Button("Cosmetic", "http://www.roblox.com/asset/?id=8395747586")

local SubButton4 = Category2:Button("ESP", "http://www.roblox.com/asset/?id=8395747586")
local SubButton5 = Category2:Button("Vision", "http://www.roblox.com/asset/?id=8395747586")

local SubButton6 = Category3:Button("IMPORTANT", "http://www.roblox.com/asset/?id=8395747586")
local SubButton7 = Category3:Button("Player", "http://www.roblox.com/asset/?id=8395747586")

local SubButton8     = Category4:Button("Powers", "http://www.roblox.com/asset/?id=8395747586")
local SubButton9     = Category4:Button("R15", "http://www.roblox.com/asset/?id=8395747586")
local SectionWalking = SubButton1:Section("Walking", "Left")
local SectionJumping = SubButton1:Section("Jumping", "Right")

local SectionHealthCS = SubButton2:Section("Health", "Left")
...
local SectionOtherC = SubButton8:Section("Others", "Right")

SectionOtherC:Button({
    Title       = "Grab Knife",
    ButtonName  = "Execute",
    Description = "Grab Knife V4",
    }, function(value)
...
local SectionHealthRAT = SubButtonBasic:Section("Player Health", "Left")


SectionHealthRAT:Button({
    Title       = "Kill",
    ButtonName  = "Copy",
    Description = "",
    }, function(value)
    local codeToCopy = "uWiiL0X23DG_JJ2DxA832F_a-JJ"
